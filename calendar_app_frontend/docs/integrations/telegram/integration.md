...
### 2. **API Client** (`lib/services/telegram/api/telegram_api_client.dart`)
...
### 3. **Domain (State Management)** (`lib/services/telegram/domain/telegram_domain.dart`)
...
│
├── presentation/screens/workspace/
│   ├── sections/telegram/
