...
| `lib/services/telegram/api/telegram_api_client.dart` | HTTP client + endpoints |
...
### **Monitor API calls:**
Check `lib/services/config/api_constants.dart` for base URL + token injection.

---

**Status:** ✅ Production Ready  
**Last Updated:** 2026-03-23  
**Questions?** Check the [integration guide](integration.md) for detailed architecture.
