// lib/models/event/event_group_resolver.dart
...
import 'package:hexora/presentation/features/events/screens/repetition_dialog/utils/show_recurrence.dart';
...
class GroupEventResolver {
  ...
  Future<List<Event>> hydrateRulesForEvents(List<Event> rawEvents) async {
    ...
    return rawEvents.map((e) {
      if (e.recurrence_rule == null && e.rawRuleId != null) {
        final r = ruleMap[e.rawRuleId];
        if (r != null) {
          return e.copyWith(recurrence_rule: r);
        } else {
          debugPrint(
  ...
  List<Event> expandForRange({
    ...
    for (final e in baseEvents) {
      ...
      final hasObjRule = e.recurrence_rule != null;
