...
import 'package:hexora/models/recurrence_rule/utils_recurrence_rule/custom_day_of_week_extensions.dart';
...
RecurrenceType mapStringToRecurrenceType(String? value) {
  if (value == null) {
    throw FormatException('Missing recurrenceType or name in recurrence_rule');
  }
