...
extension _ExpenseJsonImportTab on _ExpenseUploadImportTabsSection {
  Widget _buildJsonImportTab(AppLocalizations l,
    ...
    final jsonSettlementFields = ExpenseSettlementFields(
      ...
      onTypeChanged: (type) => _updateImportState(() {
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          GestureDetector(
            onTap: () => _updateImportState(
                () => jsonAdvancedExpanded = !jsonAdvancedExpanded),
            child: Container(
