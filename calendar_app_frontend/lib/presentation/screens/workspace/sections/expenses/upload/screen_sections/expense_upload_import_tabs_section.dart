...
mixin _ExpenseUploadImportTabsSection on _ExpenseUploadScreenStateBase {
  ...
  Future<void> _showBatchPreviewEditDialog(
    _ExpenseBatchPreviewItem item,
      ...
      _ExpensePredictionEditDialog(this)._showBatchPreviewEditDialog(item);
  ...
  Widget _buildJsonImportTab(AppLocalizations l,
      ...
      _ExpenseJsonImportTab(this)
          ._buildJsonImportTab(l, showInlineControls: showInlineControls);
  ...
  Widget _buildJsonStepRightContent(AppLocalizations l) =>
      _ExpenseJsonImportSteps(this)._buildJsonStepRightContent(l);

  @override
  Widget _buildBatchImportTab(AppLocalizations l,
          {bool showInlineControls = true}) =>
      _ExpenseBatchImportTab(this)
          ._buildBatchImportTab(l, showInlineControls: showInlineControls);

  // Keep State.setState calls on the existing lifecycle owner.
  void _updateImportState(VoidCallback action) => setState(action);
}
