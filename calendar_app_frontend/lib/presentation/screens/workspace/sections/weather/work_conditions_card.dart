...
import 'package:hexora/services/weather/work_conditions_api.dart';
    ...
    try {
      ...
      if (mounted && widget.groupId == requestedGroupId) {
        setState(() {
          ...
          _unavailable = error is WorkConditionsUnavailable;
        });
      }
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    if (_unavailable) {
      return Column(crossAxisAlignment: CrossAxisAlignment.stretch, children: [
        const WeatherSummaryCard(location: null),
        Padding(
          padding: const EdgeInsets.fromLTRB(12, 6, 12, 0),
          child: Text(
            es
                ? 'Previsión general · Sin análisis de trabajos'
                : 'General forecast · Job analysis unavailable',
