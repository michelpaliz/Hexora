...
import 'package:hexora/presentation/features/events/screens/repetition_dialog/utils/frequency_selector.dart';
import 'package:hexora/presentation/features/events/screens/repetition_dialog/utils/repetition_rule_helper.dart';
import 'package:hexora/presentation/features/events/screens/repetition_dialog/widgets/repeat_every_row.dart';
import 'package:hexora/presentation/features/events/screens/repetition_dialog/widgets/until_date_picker.dart';
import 'package:hexora/presentation/features/events/screens/repetition_dialog/widgets/weekly_day_selector.dart';
...
class _RepetitionScreenState extends State<RepetitionScreen> {
  ...
  void _goBackToParentView(
    ...
    Navigator.of(context).pop(<Object?>[recurrence_rule, isRepeated]);
  }
