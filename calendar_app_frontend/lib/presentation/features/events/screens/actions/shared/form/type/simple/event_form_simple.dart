// presentation/events/screens/actions/add_screen/screen/event_form_simple.dart
import 'package:flutter/material.dart';
import 'package:hexora/models/recurrence_rule/recurrence_rule/legacy_recurrence_rule.dart';
import 'package:hexora/data/group_management/category/category_api_client.dart';
import 'package:hexora/presentation/features/events/screens/actions/add_screen/screen/widgets/repetition_toggle_widget.dart';
import 'package:hexora/presentation/features/events/screens/actions/add_screen/utils/dialog/user_expandable_card.dart';
import 'package:hexora/presentation/features/events/screens/actions/add_screen/utils/form/color_picker_widget.dart';
import 'package:hexora/presentation/features/events/screens/actions/add_screen/utils/form/description_input_widget.dart';
import 'package:hexora/presentation/features/events/screens/actions/add_screen/utils/form/location_input_widget.dart';
import 'package:hexora/presentation/features/events/screens/actions/add_screen/utils/form/note_input_widget.dart';
import 'package:hexora/presentation/features/events/screens/actions/add_screen/utils/form/reminder_options.dart';
import 'package:hexora/presentation/features/events/screens/actions/shared/base/base_event_logic.dart';
import 'package:hexora/presentation/features/events/screens/actions/shared/form/event_dialogs.dart';
import 'package:hexora/presentation/features/events/screens/actions/shared/form/type/event_types/simple/section/category/category_picker.dart';
import 'package:hexora/presentation/features/events/screens/actions/shared/form/type/event_types/simple/section/title_section.dart';
...
import 'package:hexora/presentation/features/events/screens/actions/shared/form/type/event_types/work/widgets/work_visit/sections/date_time_section.dart';
import 'package:hexora/presentation/features/events/screens/actions/shared/form/type/event_types/work/widgets/work_visit/sections/reminder_section.dart';
import 'package:hexora/presentation/features/events/screens/actions/shared/form/type/event_types/work/widgets/work_visit/sections/section_card_builder.dart';
import 'package:hexora/presentation/features/events/screens/actions/shared/form/type/event_types/work/widgets/work_visit_style.dart';
                ...
                onTap: () async {
                  ...
                  if (widget.logic.onShowRepetitionDialog == null) {
                    setState(() => widget.logic.toggleRepetition(
                          !wasRepeated,
                          wasRepeated ? null : widget.logic.recurrence_rule,
                        ));
                    return;
                  }
                  ...
                  final result = await widget.logic.onShowRepetitionDialog!(
                    ...
                    initialRule: widget.logic.recurrence_rule,
                  );
