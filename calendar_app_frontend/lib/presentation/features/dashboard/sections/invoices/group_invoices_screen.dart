...
import 'package:hexora/models/group/group_permissions.dart';
...
import 'package:hexora/data/invoicing/billing_profile_api.dart';
import 'package:hexora/data/invoicing/invoice_api.dart';
import 'package:hexora/data/invoicing/presupuestos_api.dart';
import 'package:hexora/data/invoicing/invoice_lines_api.dart';
import 'package:hexora/data/receipts/receipts_api.dart';
import 'package:hexora/data/user/domain/user_domain.dart';
import 'package:hexora/data/vat/vat_summary_api.dart';
...
import 'package:hexora/presentation/features/dashboard/sections/invoices/group_invoice_flow/screens/invoice_editor/invoice_editor_screen.dart';
import 'package:hexora/presentation/features/dashboard/sections/invoices/group_invoice_flow/screens/invoice_editor/sections/invoice_editor_pdf.dart';
import 'package:hexora/presentation/features/dashboard/sections/invoices/group_invoice_flow/screens/invoice_editor/widgets/invoice_details_sheet/invoice_detail_sheet.dart';
...
import 'package:hexora/shared/documents/pdf_preview_launcher.dart'
    as pdf_launcher;
import 'package:hexora/presentation/features/dashboard/sections/invoices/group_invoices/expense_upload_screen.dart';
import 'package:hexora/presentation/features/dashboard/sections/invoices/shared/prompt_clipboard_helper.dart';
import 'package:hexora/presentation/features/dashboard/sections/invoices/group_invoices/widgets/billing_profile_inline_editor.dart';
import 'package:hexora/presentation/features/dashboard/sections/invoices/group_invoices/widgets/client_classifications_view.dart';
import 'package:hexora/presentation/features/dashboard/sections/invoices/group_invoices/widgets/clients_view/client_contracts_tab.dart';
import 'package:hexora/presentation/features/dashboard/sections/invoices/group_invoices/widgets/clients_view/client_invoice_comparison_view.dart';
import 'package:hexora/presentation/features/dashboard/sections/invoices/group_invoices/widgets/group_invoices_clients_view.dart';
import 'package:hexora/presentation/features/dashboard/sections/invoices/group_invoices/widgets/group_invoices_emails_view.dart';
import 'package:hexora/presentation/features/dashboard/sections/invoices/group_invoices/widgets/group_invoices_invoices_view.dart';
import 'package:hexora/presentation/features/dashboard/sections/invoices/group_invoices/widgets/group_invoices_budgets_view.dart';
import 'package:hexora/presentation/features/dashboard/sections/invoices/group_invoices/widgets/expense_vat_audit_view.dart';
import 'package:hexora/presentation/features/dashboard/sections/invoices/group_invoices/widgets/invoice_accountant_compare_view.dart';
import 'package:hexora/presentation/features/dashboard/sections/invoices/group_invoices/widgets/invoice_vat_audit_view.dart';
import 'package:hexora/presentation/features/dashboard/sections/invoices/group_invoices/widgets/presupuesto_invoice_conversion_view.dart';
import 'package:hexora/presentation/features/dashboard/sections/invoices/group_invoices/invoice_sort_query.dart';
import 'package:hexora/presentation/features/dashboard/sections/invoices/group_invoices/widgets/group_invoices_side_menu.dart';
import 'package:hexora/presentation/features/dashboard/sections/invoices/group_invoices/widgets/group_receipts_view.dart';
import 'package:hexora/presentation/features/dashboard/sections/invoices/group_invoices/widgets/invoice_row_item.dart';
import 'package:hexora/presentation/features/dashboard/sections/invoices/group_invoices/widgets/receipts_view/receipt_detail_card.dart';
import 'package:hexora/presentation/features/dashboard/sections/invoices/group_invoices/widgets/receipts_view/receipt_list_item.dart';
import 'package:hexora/presentation/features/dashboard/sections/invoices/group_invoices/widgets/vat_summary_view.dart';
import 'package:hexora/presentation/features/dashboard/sections/invoices/group_receipts_flow/screens/receipt_editor/receipt_editor_wizard_screen.dart';
...
import 'package:hexora/presentation/features/dashboard/sections/invoices/recurring_receipts/recurring_receipts_screen.dart';
import 'package:hexora/presentation/features/dashboard/sections/services_clients/client_classification_store.dart';
import 'package:hexora/presentation/features/dashboard/sections/services_clients/sheets/add_client_sheet/add_client_sheet.dart';
import 'package:hexora/presentation/features/dashboard/sections/services_clients/widgets/client_classification_manager_dialog.dart';
import 'package:hexora/presentation/features/dashboard/sections/services_clients/widgets/common_views.dart';
import 'package:hexora/presentation/features/dashboard/sections/invoices/group_invoices/widgets/bulk_download_dialog.dart';
import 'package:hexora/presentation/features/shared/widgets/folder_panel.dart';
import 'package:hexora/presentation/features/shared/widgets/snack_helper.dart';
