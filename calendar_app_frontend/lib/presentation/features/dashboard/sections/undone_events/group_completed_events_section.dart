...
import 'package:hexora/presentation/features/dashboard/sections/undone_events/group_undone_event_detail_sheet.dart';
...
import 'package:hexora/presentation/features/dashboard/sections/undone_events/group_undone_events_widgets.dart';
...
class GroupCompletedEventsSection extends StatelessWidget {
  const GroupCompletedEventsSection({
    super.key,
    required this.group,
    required this.user,
    required this.role,
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider<GroupUndoneEventsViewModel>(
      ...
      child: _GroupCompletedEventsSectionBody(
        group: group,
        user: user,
        role: role,
        limit: limit,
...
class _GroupCompletedEventsSectionBody extends StatelessWidget {
  const _GroupCompletedEventsSectionBody({
    required this.group,
    required this.user,
    required this.role,
    required this.limit,
  ...
  Widget build(BuildContext context) {
    ...
    final hasItems = vm.completedEvents.isNotEmpty;
    final visibleItems = vm.completedEvents.take(limit).toList();
      ...
      Column(
        ...
        children: [
          ListTile(
            ...
            title: Text(
              loc.completedEventsSectionTitle,
          ...
          if (vm.isLoading && !hasItems)
            ...
            UndoneEventsPlaceholder(
              ...
              message: vm.errorMessage ?? loc.completedEventsEmpty,
            ...
            UndoneEventsPlaceholder(
              ...
              message: loc.completedEventsEmpty,
            )
          else ...[
