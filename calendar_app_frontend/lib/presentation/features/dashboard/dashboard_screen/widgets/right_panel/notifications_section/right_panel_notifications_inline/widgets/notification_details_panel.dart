...
import 'package:hexora/models/notification/notification_localization.dart';
...
import 'package:hexora/presentation/features/dashboard/sections/enable_banking/statements/shared/statements_shared_utils.dart';
import 'package:hexora/presentation/features/dashboard/sections/enable_banking/statements/statements_formatters.dart';
import 'package:hexora/presentation/features/notifications/show_notifications/utils/event_args_helper.dart';
import 'package:hexora/presentation/features/notifications/show_notifications/utils/notification_category_meta.dart';
import 'package:hexora/presentation/features/notifications/show_notifications/utils/notification_formatting.dart';
      ...
      child: Column(
        ...
        children: [
          ...
          if (isEvent) ...[
            ...
            if (args.recurrence_ruleId != null)
              _IconDetailRow(
                icon: Icons.repeat_rounded,
                label: isEs ? 'Recurrencia' : 'Recurrence',
                value: args.recurrence_ruleId!,
                color: dim,
              ),
