...
import 'package:hexora/presentation/features/calendar/screens/calendar/presentation/view_adapter/adapter_flow/event_data_source/event_data_source.dart';
...
class CalendarState {
  ...
  int _signature(List<Event> list, String? filterUserId) {
    ...
    final parts = list.map((e) => Object.hash(
          ...
          e.title.hashCode,
          e.recurrence_rule?.hashCode ?? e.rule?.hashCode ?? 0,
          e.eventColorIndex,
          e.allDay ? 1 : 0,
        ));
