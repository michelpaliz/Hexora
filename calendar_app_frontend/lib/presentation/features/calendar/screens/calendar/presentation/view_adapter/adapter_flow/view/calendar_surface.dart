...
import 'package:hexora/presentation/features/calendar/screens/calendar/presentation/view_adapter/widgets/widgets_cells/cells_widgets/calendar_month_cell.dart';
import 'package:hexora/presentation/features/calendar/screens/calendar/presentation/view_adapter/widgets/widgets_cells/cells_widgets/calendar_styles.dart';
import 'package:hexora/presentation/features/calendar/screens/calendar/presentation/view_adapter/widgets/widgets_cells/month_schedule_img/calendar_styles.dart';
...
class _CalendarSurfaceState extends State<CalendarSurface> {
  ...
  Future<void> _handleAppointmentDragEnd(
    ...
    if (dragged.recurrence_rule != null || dragged.rawRuleId != null) {
      if (!mounted) return;
